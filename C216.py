...
def grb(blueprint_library):
    rb = blueprint_library.flter('sensor.other.radar')[0]
    rb.set_attribute('horizontal_fov', str(15))
    rb.set_attribute('vertical_fov', str(20))
    rb.set_attribute('points_per_second', str(1500))
    rb.set_attribute('range', str(20))
    return rb
